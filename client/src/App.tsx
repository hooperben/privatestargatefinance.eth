...
import type { NoirCircuit } from "./types/circuit";
...
function App() {
  ...
  const generateDepositProof = async (depositNote: DepositNote) => {
    ...
    try {
      const noir = new Noir(depositCircuit as NoirCircuit);
    ...
    <div className="flex flex-col items-center justify-center min-h-screen p-8 bg-gray-50">
      <div className="max-w-md w-full bg-white rounded-lg shadow-md p-6">
        ...
        <p className="text-gray-600 text-sm mb-6 text-center">
          Click the button below to generate a deposit proof using the real
          Poseidon hash from @aztec/foundation with hardcoded test values.
        </p>
